...
<head>
    ...
    <title>Site Coatching</title><!-- A retirer -->
...
<body id="page-top" class="index">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#lasalle">LES COATCHS</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#lescoachs">LA SALLE</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#lescours">LES COURS</a>
                    </li>
                    <li>
    ...
    <section id="lescoachs" class="bg-light-gray">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">La salle</h2>
...
<!-- Clients Aside -->
    ...
    <input type="button" value="test" onclick="window.open('http://localhost/SiteCoaching-master/questionnaire.php')">
    <a href="javascript:ouvrirFenetre();"> Test2 </a>
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
...
{
    window.open("http://localhost/SiteCoaching-master/questionnaire.php", "popup", "toolbar=0, location=0, directories=0, status=0, scrollbars=0, resizable=0, copyhistory=0, width=500, height=350,screenX=200,screenY=200");
}
</script>
